                ...
                <AuthContextConsumer>
                    {
                        (args)=>(
                            ...
                            <Route path={this.props.path} history={this.props.history} match={this.props.match}  render={props=>(args.isAuthenticated()?<Component {...props} {...props.match.params}  /> :<Redirect to="/login" />)} />
                        )   
                    }
                </AuthContextConsumer>    
        )
